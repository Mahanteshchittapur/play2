 ...
 * CLI version: 2.12.0
 *
 * Generated: Wed, 30 Aug 2023 05:42:51 GMT
 */

var APP_com_domain_app_play = (function () {
  'use strict';
  ...
  class App extends Lightning$1.Component {
    static _template() {
      return {
        ...
        Settlogo: {
          ...
          w: 1920,
          h: 700,
          src: Utils.asset('images/Avengers.jpg')
        },
        Belllogo: {
          x: 1400,
          y: 20,
        ...
        PlayButton: {
          ...
          on: {
            click: 'playVideo' // This event handler will be defined below
          }
        },
        ...
        Video: {
          ...
          src: '' // Initialize with an empty source
        }
      };
    }
    ...
    playVideo() {
      ...
      // Load the video using the player instance
      this._player.load(url);

      // Play the video
      const videoElement = this.tag('Video');
      videoElement.play();
    }
  }
